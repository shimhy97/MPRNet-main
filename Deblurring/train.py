...
### !!! num_workers 16 and 8 에서 0 0으로 수정, Batch_size (yml 파일) 수정
...
val_loader = DataLoader(dataset=val_dataset, batch_size=2, shuffle=False, num_workers=0, drop_last=False, pin_memory=True)
